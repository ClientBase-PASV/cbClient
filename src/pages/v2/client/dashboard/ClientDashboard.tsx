...
// import ClientStats from '@/pages/v2/client/dashboard/stats/ClientStats';
import ClientFilterForm from '@/pages/v2/client/dashboard/search/ClientFilterForm';
import Pager from '@/pages/utils/pager/Pager';
import { IClientQueryParams } from '@/pages/v2/client/types';
import ClientSearchList from '@/pages/v2/client/dashboard/search/ClientSearchList';
import ClientDashboardControls from '@/pages/v2/client/dashboard/controls/ClientDashboardControls';
import { IState } from '@/pages/v2/client/model';
...
const mapDispatchToProps = (dispatch: any) => ({
  search: (payload: IClientQueryParams) => dispatch({ type: 'v2Client/search', payload }),
  getStats: () => dispatch({ type: 'v2Client/getStats' }),
  clientReset: () => dispatch({ type: 'v2Client/reset' }),
});
