...
const ClientFormEditWrapper = (props: IProps) => {
  ...
  const isLoadingGet = get(props, 'loadingEffects.v2Client/getById', false);
  const isLoadingUpdate = get(props, 'loadingEffects.v2Client/updateById', false);
...
const mapStateToProps = (state: any) => ({
  ...
  clientInfo: state.v2Client,
  loadingEffects: state.loading.effects,
});

const mapDispatchToProps = (dispatch: any) => ({
  reset: () => dispatch({ type: 'v2Client/reset' }),
  updateById: (payload: IClient) => dispatch({ type: 'v2Client/updateById', payload }),
  getById: (payload: string) => dispatch({ type: 'v2Client/getById', payload }),
});
