...
import UsersListItemRoles from '@/pages/v2/user/userSearch/search/UsersListItemRoles';
import { IUser } from '@/pages/v2/user/userSearch/types';
import { ISidepanel, ISidepanelOpen } from '@/pages/utils/sidepanel/types';
import CountryFlag from '@/pages/v2/user/userSearch/search/CountryFlag';
...
const UsersListItem = (props: IProps) => {
  ...
  const UserSendMessage = () => {
    props.open({
      title: 'Send SMS',
      component: 'v2UserFormSendMessage',
      place: 'UsersList',
      data: { userId, userName },
      width: '375',
    });
