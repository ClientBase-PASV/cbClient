...
const Onboarding = (props: IProps) => {
  ...
  const isLoadingAuth = get(props, 'loadingEffects.v2User/auth', true);
...
const mapDispatchToProps = (dispatch: any) => ({
  userVerifyEmailSend: (payload: IVerifyEmailArg) => dispatch({ type: 'v2User/userVerifyEmailSend', payload }),
});
