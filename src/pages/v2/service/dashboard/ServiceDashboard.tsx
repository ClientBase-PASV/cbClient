...
// import ServiceStats from '@/pages/v2/service/dashboard/stats/ServiceStats';
import ServiceFilterForm from '@/pages/v2/service/dashboard/search/ServiceFilterForm';
import Pager from '@/pages/utils/pager/Pager';
import { IServiceQueryParams } from '@/pages/v2/service/types';
import ServiceSearchList from '@/pages/v2/service/dashboard/search/ServiceSearchList';
import ServiceDashboardControls from '@/pages/v2/service/dashboard/controls/ServiceDashboardControls';
import { IState } from '@/pages/v2/service/model';
