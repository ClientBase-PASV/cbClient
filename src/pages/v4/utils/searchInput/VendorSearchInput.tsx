...
const VendorSearchInput = (props: IProps) => {
  ...
  const isLoading = get(props, 'loadingEffects.v4SearchInput/vendorSearch', false);
...
const mapDispatchToProps = (dispatch: any) => ({
  search: (vendorName: string) => dispatch({ type: 'v4SearchInput/vendorSearch', payload: vendorName }),
});
