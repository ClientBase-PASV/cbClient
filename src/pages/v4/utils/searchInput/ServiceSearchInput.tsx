...
const ServiceSearchInput = (props: IProps) => {
  ...
  const isLoading = get(props, 'loadingEffects.v4SearchInput/serviceSearch', false);
...
const mapDispatchToProps = (dispatch: any) => ({
  search: (serviceName: string) => dispatch({ type: 'v4SearchInput/serviceSearch', payload: serviceName }),
});
