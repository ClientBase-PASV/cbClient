...
const ServiceFormCreateWrapper = (props: IProps) => {
  ...
  const isLoading = get(props, 'loadingEffects.v4Service/create', false);
...
const mapDispatchToProps = (dispatch: any) => ({
  create: (payload: IService) => dispatch({ type: 'v4Service/create', payload }),
  search: () => dispatch({ type: 'v4Service/search' }),
});
