...
const ClientFormEditWrapper = (props: IProps) => {
  ...
  const isLoadingGet = get(props, 'loadingEffects.v4Client/getById', false);
  const isLoadingUpdate = get(props, 'loadingEffects.v4Client/updateById', false);
...
const mapStateToProps = (state: any) => ({
  ...
  clientInfo: state.v4Client,
  loadingEffects: state.loading.effects,
});

const mapDispatchToProps = (dispatch: any) => ({
  reset: () => dispatch({ type: 'v4Client/reset' }),
  updateById: (payload: IClient) => dispatch({ type: 'v4Client/updateById', payload }),
  getById: (payload: string) => dispatch({ type: 'v4Client/getById', payload }),
});
