...
// import VendorStats from '@/pages/v4/vendor/dashboard/stats/VendorStats';
import VendorFilterForm from '@/pages/v4/vendor/dashboard/search/VendorFilterForm';
import Pager from '@/pages/utils/pager/Pager';
import { IVendorQueryParams } from '@/pages/v4/vendor/types';
import VendorSearchList from '@/pages/v4/vendor/dashboard/search/VendorSearchList';
import VendorDashboardControls from '@/pages/v4/vendor/dashboard/controls/VendorDashboardControls';
import { IState } from '@/pages/v4/vendor/model';
...
const mapStateToProps = (state: any) => ({
  Vendor: state.v4Vendor,
});

const mapDispatchToProps = (dispatch: any) => ({
  search: (payload: IVendorQueryParams) => dispatch({ type: 'v4Vendor/search', payload }),
  getStats: () => dispatch({ type: 'v4Vendor/getStats' }),
  vendorReset: () => dispatch({ type: 'v4Vendor/reset' }),
});
