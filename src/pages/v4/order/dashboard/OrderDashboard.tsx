...
// import OrderStats from '@/pages/v4/order/dashboard/stats/OrderStats';
import OrderFilterForm from '@/pages/v4/order/dashboard/search/OrderFilterForm';
import Pager from '@/pages/utils/pager/Pager';
import { IOrderQueryParams } from '@/pages/v4/order/types';
import OrderSearchList from '@/pages/v4/order/dashboard/search/OrderSearchList';
import OrderDashboardControls from '@/pages/v4/order/dashboard/controls/OrderDashboardControls';
import { IState } from '@/pages/v4/order/model';
...
const mapDispatchToProps = (dispatch: any) => ({
  search: (payload: IOrderQueryParams) => dispatch({ type: 'v4Order/search', payload }),
  getStats: () => dispatch({ type: 'v4Order/getStats' }),
  orderReset: () => dispatch({ type: 'v4Order/reset' }),
});
