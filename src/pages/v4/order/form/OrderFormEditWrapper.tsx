...
const OrderFormEditWrapper = (props: IProps) => {
  ...
  const isLoadingGet = get(props, 'loadingEffects.v4Order/getById', false);
  const isLoadingUpdate = get(props, 'loadingEffects.v4Order/updateById', false);
...
const mapStateToProps = (state: any) => ({
  ...
  orderInfo: state.v4Order,
  loadingEffects: state.loading.effects,
});

const mapDispatchToProps = (dispatch: any) => ({
  reset: () => dispatch({ type: 'v4Order/reset' }),
  updateById: (payload: IOrder) => dispatch({ type: 'v4Order/updateById', payload }),
  getById: (payload: string) => dispatch({ type: 'v4Order/getById', payload }),
});
