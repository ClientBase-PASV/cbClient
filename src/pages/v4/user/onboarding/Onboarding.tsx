...
const Onboarding = (props: IProps) => {
  ...
  const isLoadingAuth = get(props, 'loadingEffects.v4User/auth', true);
...
const mapDispatchToProps = (dispatch: any) => ({
  userVerifyEmailSend: (payload: IVerifyEmailArg) => dispatch({ type: 'v4User/userVerifyEmailSend', payload }),
});
