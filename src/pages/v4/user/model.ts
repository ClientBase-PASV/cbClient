  ...
  effects: {
    ...
    *login({ payload }, { call, put }) {
      ...
      if (name && token && userId) {
        ...
        if (!emailConfirmed) history.push('/v4/onboarding');
        else history.push('/v4/client');
      }
    },
    ...
    *logout(_, { put }) {
      ...
      history.push('/v4/user/login');
    },

    *passwordReset({ payload }, { call }) {
      yield call(queryUserPasswordReset, payload);
      history.push('/v4/user/password/reset/mailed');
    },
