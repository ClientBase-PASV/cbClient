...
import {
  queryOrderCreate,
  queryOrderDeleteById, queryOrderGetById,
  queryOrderGetStats,
  queryOrderSearch, queryOrderUpdateById,
} from '@/pages/v1/order/queries';
import { IOrder, IOrderStats } from '@/pages/v1/order/types';
