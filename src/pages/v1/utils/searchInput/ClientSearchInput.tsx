...
const ClientSearchInput = (props: IProps) => {
  ...
  const isLoading = get(props, 'loadingEffects.v1SearchInput/clientSearch', false);
...
const mapStateToProps = (state: any) => ({
  SearchInput: state.v1SearchInput,
  loadingEffects: state.loading.effects,
});

const mapDispatchToProps = (dispatch: any) => ({
  search: (clientName: string) => dispatch({ type: 'v1SearchInput/clientSearch', payload: clientName }),
});
