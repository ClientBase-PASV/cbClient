...
import OrderList from '@/pages/v3/client/view/OrderList';
import OrderCreate from '@/pages/v3/client/view/OrderCreate';
...
const mapDispatchToProps = (dispatch: any) => ({
  clientGetById: (payload: string) => dispatch({ type: 'v3Client/getById', payload }),
});
