...
// import ClientStats from '@/pages/v3/client/dashboard/stats/ClientStats';
import ClientFilterForm from '@/pages/v3/client/dashboard/search/ClientFilterForm';
import Pager from '@/pages/utils/pager/Pager';
import { IClientQueryParams } from '@/pages/v3/client/types';
import ClientSearchList from '@/pages/v3/client/dashboard/search/ClientSearchList';
import ClientDashboardControls from '@/pages/v3/client/dashboard/controls/ClientDashboardControls';
import { IState } from '@/pages/v3/client/model';
...
const mapStateToProps = (state: any) => ({
  Client: state.v3Client,
});

const mapDispatchToProps = (dispatch: any) => ({
  search: (payload: IClientQueryParams) => dispatch({ type: 'v3Client/search', payload }),
  getStats: () => dispatch({ type: 'v3Client/getStats' }),
  clientReset: () => dispatch({ type: 'v3Client/reset' }),
});
