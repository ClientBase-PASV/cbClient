...
const ClientFormEditWrapper = (props: IProps) => {
  ...
  const isLoadingGet = get(props, 'loadingEffects.v3Client/getById', false);
  const isLoadingUpdate = get(props, 'loadingEffects.v3Client/updateById', false);
...
const mapStateToProps = (state: any) => ({
  ...
  clientInfo: state.v3Client,
  loadingEffects: state.loading.effects,
});

const mapDispatchToProps = (dispatch: any) => ({
  reset: () => dispatch({ type: 'v3Client/reset' }),
  updateById: (payload: IClient) => dispatch({ type: 'v3Client/updateById', payload }),
  getById: (payload: string) => dispatch({ type: 'v3Client/getById', payload }),
});
