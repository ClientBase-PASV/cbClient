...
import { queryClientSearch } from '@/pages/v3/client/queries';
import { queryOrderSearch } from '@/pages/v3/order/queries';
import { queryVendorSearch } from '@/pages/v3/vendor/queries';
import { queryServiceSearch } from '@/pages/v3/service/queries';
