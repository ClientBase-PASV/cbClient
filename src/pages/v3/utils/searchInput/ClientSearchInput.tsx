...
const ClientSearchInput = (props: IProps) => {
  ...
  const isLoading = get(props, 'loadingEffects.v3SearchInput/clientSearch', false);
...
const mapDispatchToProps = (dispatch: any) => ({
  search: (clientName: string) => dispatch({ type: 'v3SearchInput/clientSearch', payload: clientName }),
});
