...
const VendorSearchInput = (props: IProps) => {
  ...
  const isLoading = get(props, 'loadingEffects.v3SearchInput/vendorSearch', false);
...
const mapDispatchToProps = (dispatch: any) => ({
  search: (vendorName: string) => dispatch({ type: 'v3SearchInput/vendorSearch', payload: vendorName }),
});
