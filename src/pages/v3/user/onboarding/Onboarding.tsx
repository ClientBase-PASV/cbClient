...
const Onboarding = (props: IProps) => {
  ...
  const isLoadingAuth = get(props, 'loadingEffects.v3User/auth', true);
...
const mapDispatchToProps = (dispatch: any) => ({
  userVerifyEmailSend: (payload: IVerifyEmailArg) => dispatch({ type: 'v3User/userVerifyEmailSend', payload }),
});
