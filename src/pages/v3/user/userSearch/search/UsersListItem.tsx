...
import UsersListItemRoles from '@/pages/v3/user/userSearch/search/UsersListItemRoles';
import { IUser } from '@/pages/v3/user/userSearch/types';
import { ISidepanel, ISidepanelOpen } from '@/pages/utils/sidepanel/types';
import CountryFlag from '@/pages/v3/user/userSearch/search/CountryFlag';
...
const UsersListItem = (props: IProps) => {
  ...
  const UserSendMessage = () => {
    props.open({
      title: 'Send SMS',
      component: 'v3UserFormSendMessage',
      place: 'UsersList',
      data: { userId, userName },
      width: '375',
    });
