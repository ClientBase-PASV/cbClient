...
// import ServiceStats from '@/pages/v3/service/dashboard/stats/ServiceStats';
import ServiceFilterForm from '@/pages/v3/service/dashboard/search/ServiceFilterForm';
import Pager from '@/pages/utils/pager/Pager';
import { IServiceQueryParams } from '@/pages/v3/service/types';
import ServiceSearchList from '@/pages/v3/service/dashboard/search/ServiceSearchList';
import ServiceDashboardControls from '@/pages/v3/service/dashboard/controls/ServiceDashboardControls';
import { IState } from '@/pages/v3/service/model';
...
const mapDispatchToProps = (dispatch: any) => ({
  search: (payload: IServiceQueryParams) => dispatch({ type: 'v3Service/search', payload }),
  // getStats: () => dispatch({ type: 'v3Service/getStats' }),
