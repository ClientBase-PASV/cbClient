...
// import VendorStats from '@/pages/v3/vendor/dashboard/stats/VendorStats';
import VendorFilterForm from '@/pages/v3/vendor/dashboard/search/VendorFilterForm';
import Pager from '@/pages/utils/pager/Pager';
import { IVendorQueryParams } from '@/pages/v3/vendor/types';
import VendorSearchList from '@/pages/v3/vendor/dashboard/search/VendorSearchList';
import VendorDashboardControls from '@/pages/v3/vendor/dashboard/controls/VendorDashboardControls';
import { IState } from '@/pages/v3/vendor/model';
...
const mapStateToProps = (state: any) => ({
  Vendor: state.v3Vendor,
});

const mapDispatchToProps = (dispatch: any) => ({
  search: (payload: IVendorQueryParams) => dispatch({ type: 'v3Vendor/search', payload }),
  getStats: () => dispatch({ type: 'v3Vendor/getStats' }),
  vendorReset: () => dispatch({ type: 'v3Vendor/reset' }),
});
