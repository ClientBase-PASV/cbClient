...
// import OrderStats from '@/pages/v3/order/dashboard/stats/OrderStats';
import OrderFilterForm from '@/pages/v3/order/dashboard/search/OrderFilterForm';
import Pager from '@/pages/utils/pager/Pager';
import { IOrderQueryParams } from '@/pages/v3/order/types';
import OrderSearchList from '@/pages/v3/order/dashboard/search/OrderSearchList';
import OrderDashboardControls from '@/pages/v3/order/dashboard/controls/OrderDashboardControls';
import { IState } from '@/pages/v3/order/model';
...
const mapDispatchToProps = (dispatch: any) => ({
  search: (payload: IOrderQueryParams) => dispatch({ type: 'v3Order/search', payload }),
  getStats: () => dispatch({ type: 'v3Order/getStats' }),
  orderReset: () => dispatch({ type: 'v3Order/reset' }),
});
