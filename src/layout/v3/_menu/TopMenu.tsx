...
import { IUserAccount } from '@/pages/v3/user/userSearch/types';
...
const TopMenu = (props: IProps) => {
  ...
  const mainMenu = [
    { path: `/v3/client`, name: 'Clients', perm: 'client.get.own' },
    { path: `/v3/order`, name: 'Orders', perm: 'order.get.own' },
    { path: `/v3/vendor`, name: 'Vendors', perm: 'vendor.get.own' },
    { path: `/v3/service`, name: 'Services', perm: 'service.get.own' },
    { path: `/v3/report`, name: 'Report', perm: 'service.get.own' },
  ].map((el) => ({
    ...el,
